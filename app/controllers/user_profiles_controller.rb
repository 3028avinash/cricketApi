class UserProfilesController < ApplicationController
  ...
  def new
    ...
    @user_profile.user = User.find rand(1..User.count)
  end
  ...
  private
    ...
    def user_profile_params
      params.require(:user_profile).permit(:name, :email, :mobile, :birthDate, :location, :gender, :profile_pic, :occupation, :source_ip, :user_id)
    end
end

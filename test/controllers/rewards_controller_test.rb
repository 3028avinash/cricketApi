...
class RewardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reward" do
    assert_difference("Reward.count") do
      post rewards_url, params: { reward: { amount: @reward.amount, logo: @reward.logo, name: @reward.name } }
    end
  ...
  test "should update reward" do
    patch reward_url(@reward), params: { reward: { amount: @reward.amount, logo: @reward.logo, name: @reward.name } }

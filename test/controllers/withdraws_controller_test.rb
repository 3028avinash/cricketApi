...
class WithdrawsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create withdraw" do
    assert_difference("Withdraw.count") do
      post withdraws_url, params: { withdraw: { account_id: @withdraw.account_id, coin: @withdraw.coin, coin_amount: @withdraw.coin_amount, txn_in: @withdraw.txn_in } }
    end
  ...
  test "should update withdraw" do
    patch withdraw_url(@withdraw), params: { withdraw: { account_id: @withdraw.account_id, coin: @withdraw.coin, coin_amount: @withdraw.coin_amount, txn_in: @withdraw.txn_in } }
